...
export const profileActivityData2 = [
    {
        ...
        description: 'OCMONO is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology\'s.',
        badges: [
