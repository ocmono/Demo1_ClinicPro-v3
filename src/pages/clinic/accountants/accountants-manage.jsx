...
const AccountantsManage = () => {
  ...
  const stats = useMemo(() => {
    ...
    const onLeave = accountants.filter(a => a.status === 'On Leave').length;
    const inactive = accountants.filter(a => a.status === 'Inactive').length;
    
    return { total, active, onLeave, inactive };
  }, [accountants]);

  const tabs = [
    { id: 'list', label: 'All Accountants', icon: FiUsers },
    { id: 'overview', label: 'Overview', icon: FiBarChart },
    { id: 'add', label: 'Add Accountant', icon: FiUserPlus }
  ];
    ...
    <>
      <PageHeader>
        <div className="d-flex align-items-center justify-content-between">
          <div>
            <h4 className="mb-1 fw-bold">Manage Accountants</h4>
            <p className="text-muted mb-0">Add, edit, and manage accountant profiles</p>
          </div>
            ...
            {activeTab === 'overview' && (
              <div className="row g-4">
                ...
                <div className="col-md-3">
                  <div className="card bg-primary-subtle border-0">
                    <div className="card-body text-center">
                      ...
                      <p className="text-muted mb-0">Total Accountants</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="card bg-success-subtle border-0">
                    <div className="card-body text-center">
                      ...
                      <p className="text-muted mb-0">Active Accountants</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-3">
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header">
                      <h6 className="fw-bold mb-0">Accountants by Status</h6>
                    </div>
                    <div className="card-body">
                        ...
                        <div className="col-md-4">
                          <div className="d-flex align-items-center justify-content-between p-3 bg-light rounded">
                            ...
                            <div className="text-end">
                              ...
                              <small className="text-muted">accountants</small>
                            </div>
                          </div>
                        </div>
                        <div className="col-md-4">
...
export default AccountantsManage; 