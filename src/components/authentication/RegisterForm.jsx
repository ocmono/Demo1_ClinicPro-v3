...
const RegisterForm = ({path}) => {
    return (
        <>
            ...
            <h4 className="fs-13 fw-bold mb-2">Manage all your OCMONO crm</h4>
            ...
            <form action="index.html" className="w-100 mt-4 pt-2">
                ...
                <div className="mt-4">
                    <div className="custom-control custom-checkbox mb-2">
                        ...
                        <label className="custom-control-label c-pointer text-muted" htmlFor="receiveMial" style={{ fontWeight: '400 !important' }}>Yes, I wnat to receive OCMONO community
                            emails</label>
                    </div>
