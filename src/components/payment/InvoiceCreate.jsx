                            ...
                            <div className="d-md-flex align-items-center justify-content-between">
                                <div className="mb-4 mb-md-0 your-brand">
                                    <label htmlFor='img' className="wd-100 ht-100 mb-0 position-relative overflow-hidden border border-gray-2 rounded">
                                        <img src={uploadedImage || "/images/logo-clinicpro.png"} className="upload-pic img-fluid rounded h-100 w-100" alt="Uploaded" />
                        ...
                        <div className="px-4 row justify-content-between">
                            <div className="col-xl-3">
                                <div className="form-group mb-3">
                                    ...
                                    <input type="text" className="form-control" id="InvoiceLabel" placeholder="OCMONO Invoice" />
                                </div>
                            </div>
                            <div className="col-xl-3">
                                <div className="form-group mb-3">
