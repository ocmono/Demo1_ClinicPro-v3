...
const tasksData = [
    ...
    { taskNumber: '04', taskName: 'OCMONO public pnnouncement ', taskDate: '20/02/2023', taskDescription: 'Lorem ipsum dolor, sit amet consectetur adipisicing elit.', status: taskStatusOptions, priority: taskPriorityOptions, assignee: taskAssigneeOptions },
...
const Tasks = ({ title }) => {
    ...
    const defaultAssigneeList = ["arcie.tones@ocmono.com", "jon.tones@ocmono.com", "lanie.nveyn@ocmono.com", "nneth.une@ocmono.com", "erna.serpa@outlook.com"]
    return (
