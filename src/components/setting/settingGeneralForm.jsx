                        ...
                        <div className="card-body">
                            <div className="mb-5">
                                <label htmlFor='img' className="wd-100 ht-100 position-relative overflow-hidden border border-gray-2 rounded d-inline-block" style={{ marginBottom: "-8px" }}>
                                    <img src={uploadedImage || "/images/logo-clinicpro.png"} className="upload-pic img-fluid rounded h-100 w-100" alt="img" />
                            ...
                            <InputTopLabel
                                label={"Domain"}
                                placeholder={"Domain"}
                                info={"Company main domain [Ex: https://ocmono.com]"}
                            />
                            <InputTopLabel
                                label={"Allowed"}
