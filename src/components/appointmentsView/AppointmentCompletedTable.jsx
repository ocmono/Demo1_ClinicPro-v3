...
const AppointmentCompletedTable = () => {
  ...
  const getFilteredCompletedAppointments = useMemo(() => {
    ...
    if (isDoctor && currentDoctorId) {
      filteredAppointments = filteredAppointments.filter(appt => {
        ...
        console.log('Completed Appointments Doctor filter check:', {
  ...
  const tableData = useMemo(() => {
    return getFilteredCompletedAppointments
      .map((appt, index) => {
  ...
  }, [getFilteredCompletedAppointments]);
...
export default AppointmentCompletedTable;