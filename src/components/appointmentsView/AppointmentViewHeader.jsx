...
const moreOptions = [
    { label: "Pin Appointment", icon: "feather-map-pin" },
    { label: "Edit Appointment", icon: "feather-edit" },
    { label: "Copy Appointment", icon: "feather-copy" },
    { type: "divider" },
    ...
    { type: "divider" },
    { label: "Export Appointment", icon: "feather-cast" },
    { label: "Appointment View", icon: "feather-eye" },
    { type: "divider" },
    { label: "Delete Appointment", icon: "feather-trash-2" },
]
const AppointmentViewHeader = () => {
    return (
        <div className="d-flex align-items-center gap-2 page-header-right-items-wrapper">
            ...
            <Link to="/appointments/book-appointment" className="btn btn-primary">
