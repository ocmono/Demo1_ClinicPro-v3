...
import { FiAlignLeft, FiArrowLeft, FiAlignRight, FiArrowRight, FiChevronRight, FiMaximize, FiMinimize, FiMoon, FiPlus, FiSun, } from "react-icons/fi";
...
const Header = ({ children, sticky = false }) => {
            ...
            <div className="header-wrapper">
                ...
                <div className="header-left d-flex align-items-center gap-4">
                    ...
                    <div className="nxl-drp-link nxl-lavel-mega-menu">
                        ...
                        {/* <div className={`page-header shadow-none ${sticky ? "sticky-top" : ""}`}>
