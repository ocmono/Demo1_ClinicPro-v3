            ...
            <div className="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                <div className="dropdown-header">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            <h6 className="text-dark mb-0">{user?.name || user?.username || 'User'} <span className="badge bg-soft-success text-success ms-1">PRO</span></h6>
                            <span className="fs-12 fw-medium text-muted">{user?.email || user?.username || 'user@example.com'}</span>
                        </div>
                    </div>
                </div>
                ...
                <Link to="/settings/clinic" className="dropdown-item">
                    <i><FiSettings /></i>
